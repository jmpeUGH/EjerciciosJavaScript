...
const alienCucush = aliens.find((alien => {return alien.name === "Cucushumushu"}));
//console.log(alienCucush);

const mutaPoromp = mutations.find((mutation => {return mutation.name === "Porompompero"}));
//console.log(mutaPoromp);

alienCucush.mutation = mutaPoromp;
